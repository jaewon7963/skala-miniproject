...
export const mockTags = [
  ...
  { id: 'energy', name: '에너지' },
  { id: 'mobility', name: '모빌리티' },
  { id: 'platform', name: '플랫폼' },
  { id: 'foodtech', name: '푸드테크' },
  { id: 'agritech', name: '애그테크' },
  { id: 'series-a', name: '시리즈A' },
  { id: 'demo', name: '실증' },
  { id: 'resubmit', name: '재제출' },
  { id: 'urgent', name: '긴급' },
]
...
export const mockDocuments = [
  ...
  },
  {
    ...
    tags: ['government', 'rnd', 'manufacturing', 'resubmit'],
    latestJobId: null,
  ...
  {
    id: 'doc-5',
    name: '수소 연료전지 실증사업 계획서',
    version: 2,
    pageCount: 42,
    sizeBytes: 9.8 * 1024 * 1024,
    status: DOC_STATUS.DONE,
    tags: ['government', 'rnd', 'energy', 'demo'],
    latestJobId: 'job-3',
    updatedAt: '2026-08-27T16:35:00+09:00',
    summary: '수소 충전 인프라 실증 과제',
  },
  {
    id: 'doc-6',
    name: '반려동물 헬스케어 플랫폼 IR',
    version: 1,
    pageCount: 24,
    sizeBytes: 3.4 * 1024 * 1024,
    status: DOC_STATUS.REVIEWING,
    tags: ['investment', 'healthcare', 'platform', 'series-a'],
    latestJobId: 'job-1',
    updatedAt: '2026-08-26T10:12:00+09:00',
    summary: '시리즈A 투자 유치용 IR',
  },
  {
    id: 'doc-7',
    name: '스마트 물류 로봇 사업화 계획서',
    version: 4,
    pageCount: 31,
    sizeBytes: 6.7 * 1024 * 1024,
    status: DOC_STATUS.DONE,
    tags: ['robotics', 'rnd', 'logistics'],
    latestJobId: 'job-4',
    updatedAt: '2026-08-25T09:48:00+09:00',
    summary: '물류센터 자율주행 로봇 도입 계획',
  },
  {
    id: 'doc-8',
    name: '태양광 폐패널 재활용 사업계획서',
    version: 1,
    pageCount: 19,
    sizeBytes: 2.9 * 1024 * 1024,
    status: DOC_STATUS.IDLE,
    tags: ['eco', 'government', 'energy'],
    latestJobId: null,
    updatedAt: '2026-08-24T14:02:00+09:00',
    summary: '업로드 완료 · 분석 대기',
  },
  {
    id: 'doc-9',
    name: '의료 영상 판독 보조 AI 과제제안서',
    version: 2,
    pageCount: 38,
    sizeBytes: 7.2 * 1024 * 1024,
    status: DOC_STATUS.DONE,
    tags: ['ai', 'healthcare', 'government', 'urgent'],
    latestJobId: 'job-3',
    updatedAt: '2026-08-23T11:26:00+09:00',
    summary: '흉부 X-ray 판독 보조 모델 개발',
  },
  {
    id: 'doc-10',
    name: '중고 전기차 배터리 진단 서비스',
    version: 1,
    pageCount: 22,
    sizeBytes: 4.0 * 1024 * 1024,
    status: DOC_STATUS.FAILED,
    tags: ['eco', 'investment', 'mobility'],
    latestJobId: null,
    updatedAt: '2026-08-22T17:55:00+09:00',
    summary: '암호화된 PDF · 텍스트 추출 불가',
  },
  {
    id: 'doc-11',
    name: '푸드테크 대체육 생산라인 구축 계획',
    version: 3,
    pageCount: 27,
    sizeBytes: 5.1 * 1024 * 1024,
    status: DOC_STATUS.DONE,
    tags: ['investment', 'rnd', 'foodtech', 'manufacturing'],
    latestJobId: 'job-4',
    updatedAt: '2026-08-21T13:40:00+09:00',
    summary: '대체육 양산 설비 투자 계획',
  },
  {
    id: 'doc-12',
    name: '농업용 드론 방제 서비스 사업계획서',
    version: 1,
    pageCount: 16,
    sizeBytes: 2.3 * 1024 * 1024,
    status: DOC_STATUS.IDLE,
    tags: ['robotics', 'eco', 'agritech'],
    latestJobId: null,
    updatedAt: '2026-08-20T08:15:00+09:00',
    summary: '업로드 완료 · 분석 대기',
  },
  {
    id: 'doc-13',
    name: '시니어 돌봄 로봇 정부과제 계획서',
    version: 2,
    pageCount: 29,
    sizeBytes: 5.8 * 1024 * 1024,
    status: DOC_STATUS.REVIEWING,
    tags: ['robotics', 'healthcare', 'government', 'demo'],
    latestJobId: 'job-1',
    updatedAt: '2026-08-19T15:07:00+09:00',
    summary: '고령자 생활 보조 로봇 실증',
  },
  {
    id: 'doc-14',
    name: '산업용 AI 예지보전 솔루션 제안서',
    version: 1,
    pageCount: 33,
    sizeBytes: 6.4 * 1024 * 1024,
    status: DOC_STATUS.DONE,
    tags: ['ai', 'rnd', 'manufacturing', 'urgent'],
    latestJobId: 'job-3',
    updatedAt: '2026-08-18T10:52:00+09:00',
    summary: '설비 고장 예측 모델 도입 제안',
  },
  {
    id: 'doc-15',
    name: '해상풍력 유지보수 선박 도입 계획서',
    version: 1,
    pageCount: 25,
    sizeBytes: 4.6 * 1024 * 1024,
    status: DOC_STATUS.IDLE,
    tags: ['eco', 'investment', 'energy', 'mobility'],
    latestJobId: null,
    updatedAt: '2026-08-17T09:30:00+09:00',
    summary: '업로드 완료 · 분석 대기',
  },
]
